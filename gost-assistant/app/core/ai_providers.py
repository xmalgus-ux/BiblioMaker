...
11) Сведения об издании обязательно сохраняй: «2-е изд.», «испр.», «доп.», «перераб.», «стер.», «учеб. пособие», «монография» и похожие элементы нельзя удалять.
...
- Не удаляй сведения об издании и виде издания. Например, если во входе есть «2-е изд., испр. и доп.», оно должно остаться в исправленной записи.
